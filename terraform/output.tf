...
resource "null_resource" "generate_inventory" {
  provisioner "local-exec" {
    command = <<EOF
      echo "[app_servers]" > /home/baher/agent/workspace/project/inventory.ini
      echo "ec2-instance ansible_host=${aws_instance.ubuntu-instance.public_ip} ansible_user=ubuntu ansible_ssh_private_key_file=/home/baher/agent/workspace/project/mykey.pem ansible_ssh_common_args='-o StrictHostKeyChecking=no'" >> /home/baher/agent/workspace/project/inventory.ini
EOF
  }
}
